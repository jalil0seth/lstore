    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[9999] flex items-center justify-center overflow-y-auto">
      ...
      >
        <div className="sticky top-0 bg-white z-10 p-4 border-b">
          <button
            onClick={onClose}
            className="absolute right-4 top-4 text-light hover:text-gray-700"
          >
            <X size={20} />
          </button>
          <h2 className="text-xl font-bold text-default text-center">Order Summary</h2>
        </div>
          ...
          <>
            <div className="p-4 space-y-4 overflow-y-auto">
              ...
              <div className="bg-subtle rounded-xl p-4 space-y-4">
                ...
                <div className="flex justify-between items-center hover:brightness-0 hover:invert transition-all duration-200">
                  <p className="text-sm text-muted">Date: {date}</p>
                  <img 
                ...
                <div className="bg-primary-subtle rounded-lg p-3">
                  ...
                  <p className="font-mono text-primary font-medium">{orderId}</p>
                </div>
                ...
                <div className="bg-white rounded-lg p-3">
                  <p className="text-sm text-default">{fullName}</p>
                  {companyName && <p className="text-sm text-muted">{companyName}</p>}
                  <p className="text-sm text-muted">{email}</p>
                </div>

                {/* Process Steps - Simplified */}
                <div className="bg-primary-subtle rounded-lg p-4">
                  <h4 className="text-sm font-medium text-primary-dark mb-3">What happens next?</h4>
                  <div className="space-y-3">
                    <div className="flex gap-2 items-start">
                      <Clock className="w-4 h-4 text-primary-light flex-shrink-0 mt-1" />
                      <div>
                        <p className="text-sm font-medium text-primary-dark">1. Pay via PayPal</p>
                        <p className="text-xs text-primary">Quick and secure payment</p>
                      </div>
                    </div>
                    <div className="flex gap-2 items-start">
                      <Mail className="w-4 h-4 text-primary-light flex-shrink-0 mt-1" />
                      <div>
                        <p className="text-sm font-medium text-primary-dark">2. Get License Key</p>
                        <p className="text-xs text-primary">Check your email for license and setup guide</p>
                      </div>
                    </div>
                    <div className="flex gap-2 items-start">
                      <CheckCircle2 className="w-4 h-4 text-primary-light flex-shrink-0 mt-1" />
                      <div>
                        <p className="text-sm font-medium text-primary-dark">3. Start Using</p>
                        <p className="text-xs text-primary">Instant access to all premium features</p>
                      </div>
                    </div>
                  </div>

                  <div className="mt-3 pt-2 border-t border-primary-subtle">
                    <p className="text-xs text-primary">You'll be redirected back after payment. 24/7 support available if needed.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="sticky bottom-0 bg-white border-t p-4 space-y-3">
              <div className="text-center text-sm text-muted">
                ...
                <div className="w-full h-1 bg-progress-track rounded-full mt-2">
                  <motion.div
                    initial={{ width: 0 }}
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  onClick={onClose}
                  className="text-light hover:text-gray-800 text-sm font-medium py-2"
                >
                  Cancel Order
                </button>
              </div>
