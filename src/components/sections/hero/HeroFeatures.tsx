...
export const HeroFeatures = () => {
  ...
  const features = [
    { icon: Clock, text: heroData.benefits[0], color: "text-accent-blue" },
    { icon: Gift, text: heroData.benefits[1], color: "text-accent-purple" },
    { icon: Zap, text: heroData.benefits[2], color: "text-accent-yellow" }
  ];
